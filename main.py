...
desviacionDatos = tkinter.Button(text="Desviacion entre datos", command=lambda: fun.obtenerFormula(formula.get(), variables.get(), deltas= delta_x.get(), trigger=False))       # Hacemos un boton con el cual ejecutar las acciones que queramos
